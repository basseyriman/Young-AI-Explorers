-- Young AI Explorers — Full Platform Schema
-- Run in Supabase SQL Editor: https://supabase.com/dashboard/project/lvdygbetmlqjnhrmvwjq/sql

-- ─── Countries (all nations + featured flag) ───────────────────────────────
...
CREATE TABLE IF NOT EXISTS profiles (
  ...
  nickname TEXT,
  avatar_url TEXT,
  country_code TEXT REFERENCES countries(code) DEFAULT 'GB',
...
-- ─── Trigger: record topic activity on badge earn ───────────────────────────
