    ...
    <div className="flex min-h-screen flex-col bg-slate-50 font-sans text-slate-900 selection:bg-blue-500/30 overflow-hidden">
      ...
      <main className="relative z-10 flex-1 container mx-auto px-6 py-12 space-y-10 max-w-6xl">
        ...
        <section className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          {/* AI Assistant Module */}
          <div className="group relative overflow-hidden rounded-[32px] border-2 border-slate-100 bg-white p-8 transition-all duration-500 hover:-translate-y-2 hover:border-purple-300 hover:shadow-2xl hover:shadow-purple-900/10 cursor-pointer flex flex-col justify-between">
            <div className="relative z-10">
              <div className="mb-8 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-purple-50 border border-purple-100 text-purple-600 group-hover:scale-110 transition-transform duration-500 group-hover:bg-purple-500 group-hover:text-white group-hover:shadow-lg group-hover:shadow-purple-500/30">
                <Compass className="h-7 w-7" />
              </div>
              <h3 className="font-heading text-xl font-bold text-slate-900 mb-3">AI Explorer Assistant</h3>
              <p className="text-slate-500 text-sm font-medium leading-relaxed mb-8">
                Need help with a tricky concept? The AI Assistant is online and ready to guide you.
              </p>
            </div>
            <div className="relative z-10 inline-flex items-center text-sm font-bold text-purple-600 group-hover:text-purple-700 transition-colors">
