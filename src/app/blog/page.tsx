...
export default function BlogPage() {
  ...
  const regularPosts = filteredArticles.filter(a => !a.featured || search || activeCategory !== "All");
        ...
        {filteredArticles.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {(search || activeCategory !== "All" ? filteredArticles : regularPosts).map((art) => (
              ...
              >
                <div>
                  <div className="flex items-center justify-between gap-4 mb-4 text-xs text-brand-purple/50 dark:text-brand-cream/50">
